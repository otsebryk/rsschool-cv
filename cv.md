...
- HTML, CSS, TailWind CSS, JavaScript, Pyhton, React (basic);
- Git, GitHub, Figma, Vite;
- Responsive design, GitFlow, AI-assisted developed;
- Node.js basics;

---

## Languages
- English: Working proficiency (B1, actively developing);
- Finnish: Basic proficiency (A2, workplace communication);
- Ukrainin, Russian: Native;
